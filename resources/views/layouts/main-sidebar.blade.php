...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج الضرائب</li>
            <li class="slide">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">انواع المؤسسات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- @can('الاقسام') --}}
                    <li><a class="slide-item" href="{{ route('types.create') }}">اضافه نوع جديد</a></li>
                    {{-- @endcan --}}

                    {{-- @can('المنتجات') --}}
                    <li><a class="slide-item" href="{{ route('types') }}">عرض الكل</a></li>
                    {{-- @endcan --}}
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">انواع القطاعات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- @can('الاقسام') --}}
                    <li><a class="slide-item" href="{{ route('setions.create') }}">اضافه قطاع جديد</a></li>
                    {{-- @endcan --}}

                    {{-- @can('المنتجات') --}}
                    <li><a class="slide-item" href="{{ route('setions') }}">عرض الكل</a></li>
                    {{-- @endcan --}}
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">المؤسسات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- @can('الاقسام') --}}
                    <li><a class="slide-item" href="{{ route('institutions.create') }}">اضافه مؤسسه جديد</a></li>
                    {{-- @endcan --}}

                    {{-- @can('المنتجات') --}}
                    <li><a class="slide-item" href="{{ route('institutions') }}">عرض الكل</a></li>
                    {{-- @endcan --}}
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    {{-- @can('الاقسام') --}}
                    <li><a class="slide-item" href="{{ route('employees.create') }}">اضافه موظف جديد </a></li>
                    {{-- @endcan --}}

                    {{-- @can('المنتجات') --}}
                    <li><a class="slide-item" href="{{ route('employees') }}">عرض الكل</a></li>
                    {{-- @endcan --}}
                </ul>
            </li>
            {{--            </svg><span class="side-menu__label">انواع المؤسسات</span><i class="angle fe fe-chevron-down"></i></a>--}}
{{--            <ul class="slide-menu">--}}
{{--                --}}{{-- @can('الاقسام') --}}
{{--                <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">اضافه نوع جديد</a></li>--}}
{{--                --}}{{-- @endcan --}}
