            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form"
                        ...
                        @csrf
                        <input type="hidden" name="id" value="{{$inistitution -> id}}">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="name" value="{{$inistitution -> inst_name}}" required type="text">
                            </div>

                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                <label> تاريخ التاسيس </label>
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="date" value="{{$inistitution -> found_year}}" required type="date">
                            </div>
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                <label> الموقع </label>
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="location" value="{{$inistitution -> location}}" required type="text">
                            </div>
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                <label> التلفون </label>
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="phone" value="{{$inistitution -> phone_no}}" required type="text">
                            </div>
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                <label> البريد الالكتروني </label>
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="email" value="{{$inistitution -> email}}" required type="email">
                            </div>
